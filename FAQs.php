...
<body>
    ...
    <div class="row">
        <div class="accordion accordion-flush shadow p-3 col-md-6 col-sm-12" id="accordionFlushExample">
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingOne">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                         <?php echo $que['Question'];?> <!--this will display the quesion on the website -->
                    </button>
                </h2>
                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                    ...
                    <b> 
                    Answer::<?php echo $que['Answer'];?> <!--this display show the answer of the question on the website -->
                     </b>   
                    </div>
                </div>
            </div>
        ...
        <div class="accordion accordion-flush shadow p-3 col-md-6 col-sm-12" id="accordionFlushExample">
            <div class="accordion-item">
                ...
                <div id="flush-collapseSix" class="accordion-collapse collapse" aria-labelledby="flush-headFiveSix"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body"><b> 
                    Answer::<?php echo $que['Answer'];?>
                     </b>   </div>
    ...
    <footer class="my-4">
        ...
        <p class="text-center text-muted">© 2022 PyProjects, Inc</p>
    </footer>
...
$mail->Body    = 'thanks '.$fname.' '.$lname.' for asking your doubt!<br>here is your doubt<br>'.$question.'<br>u will get response from us within 2 working days!';
